...
| Faturalama iskeleti | Plan tier'ları, deneme süresi, koltuk limiti, yükseltme talebi (DB+UI) | v0.5.10 | 🟡 (manuel/havale + TAMI sanal POS kart ödemesi/3DS kodda hazır, prod go-live testi bekliyor — iyzico değil) |
