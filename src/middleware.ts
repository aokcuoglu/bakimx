...
const PUBLIC_EXACT = new Set(["/", "/login", "/admin-login", "/forgot-password", "/register", "/privacy", "/terms", "/kvkk", "/acik-riza", "/fiyatlar", "/oto-servis-programi", "/dijital-arac-kabul", "/is-emri-programi", "/karsilastir/defter-excel-oto-servis-programi", "/status", "/robots.txt", "/sitemap.xml", "/llms.txt", "/opengraph-image", "/twitter-image"])
