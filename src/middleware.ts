...
const PUBLIC_EXACT = new Set(["/", "/login", "/admin-login", "/forgot-password", "/register", "/privacy", "/terms", "/kvkk", "/acik-riza", "/fiyatlar", "/oto-servis-programi", "/status", "/robots.txt", "/sitemap.xml", "/opengraph-image", "/twitter-image"])
