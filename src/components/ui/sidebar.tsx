...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      document.cookie = `${SIDEBAR_COOKIE_NAME}=${openState ? "expanded" : "collapsed"}; path=/; max-age=${SIDEBAR_COOKIE_MAX_AGE}; SameSite=Lax`
    },
    [setOpenProp, open]
  )
...
function SidebarMenuButton({
  ...
  const comp = (
    <Comp
      ...
      data-size={size}
      // Tailwind `data-active:` varlık seçicisine derlenir; `false` yazmak
      // `data-active="false"` üretip seçiciyi eşleştirirdi.
