        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
            <div className="space-y-1">
              ...
              >
                <AutocompleteInput
                  // Liste KAPALIYKEN Base UI Escape'te input değerini sessizce
                  // temizliyor (bilinen tuzak, bkz. quote-create-form.tsx
                  // LaborNameAutocomplete) — yazılan kategori adı yok oluyor. Liste
                  // AÇIKKEN Escape'in listeyi kapatma davranışı korunmalı, o yüzden
                  // yalnız kapalıyken susturuyoruz (aria-expanded="false").
                  onKeyDown={(e) => {
