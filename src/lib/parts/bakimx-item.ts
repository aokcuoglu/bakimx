...
/**
 * Araç uyumluluk kontrolü (`validateBakimxProductFitment`) bu modülde DEĞİL,
 * `./bakimx-fitment` içinde: burası istemci bileşenlerinin de import ettiği saf
 * bir modül, Prisma erişimi eklenirse istemci paketi kırılır.
 */
