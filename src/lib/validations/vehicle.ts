...
// NOT: `vinConfirmed` bilerek YOK. #179 ile manuel "ruhsatla teyit edildi"
// kutusu kaldırıldı; sunucu bu değeri deriveVinConfirmed ile VIN'den türetiyor
// ve istemciden gelen bir teyit iddiasını dikkate almıyor.
