// Vendored from the `jscanify` npm package (client/browser UMD build, MIT).
// Vendored to avoid jscanify's transitive `canvas` (native) + `jsdom` deps in the prod install.
// Source: node_modules/jscanify/src/jscanify.js (v1.4.x). Uses the global `cv` (OpenCV.js). Do not edit.
