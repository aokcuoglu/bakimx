...
export async function startWorkAction(orderId: string) {
  ...
  revalidatePath(`/app/technician/orders/${orderId}`)
  revalidatePath("/app/technician")
  revalidatePath(`/app/orders/${orderId}`)
  revalidatePath("/app/orders")
  return { success: true }
...
export async function addChecklistItemAction(formData: FormData) {
  ...
  revalidatePath(`/app/technician/orders/${raw.serviceOrderId}`)
...
export async function toggleChecklistItemAction(itemId: string, checked: boolean) {
  ...
  revalidatePath(`/app/technician/orders/${item.serviceOrderId}`)
  revalidatePath(`/app/orders/${item.serviceOrderId}`)
  return { success: true }
}
...
export async function deleteInternalNoteAction(noteId: string) {
  ...
  revalidatePath(`/app/technician/orders/${note.serviceOrderId}`)
  revalidatePath(`/app/orders/${note.serviceOrderId}`)
  return { success: true }
}
...
export async function updatePartsRequestStatusAction(requestId: string, status: string) {
  ...
  revalidatePath(`/app/technician/orders/${request.serviceOrderId}`)
  revalidatePath(`/app/orders/${request.serviceOrderId}`)
  return { success: true }
}
